...
(function (root, factory) {
  ...
  Lightbox.prototype.build = function() {
    ...
    this.$lightbox.find('.lb-rotate').on('click', function() {
      if (self.$cont.attr('angle') == null) {
        self.$cont.attr('angle', 0);
      }

      var value = Number(self.$cont.attr('angle'));
      value -= 90;
  
      self.$cont.rotate({ animateTo:value});
      self.$cont.attr('angle', value);
      return false;
    });
  ...
  Lightbox.prototype.end = function() {
    ...
    this.$cont.rotate({ animateTo: 0});
    this.$cont.attr('angle', 0);
  };
